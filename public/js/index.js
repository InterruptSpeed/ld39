...
GameState.prototype.create = function() {
    ...
    this.boulder.scale.x += 0.5;
    this.boulder.scale.y += 0.5;
...
GameState.prototype.update = function() {
    ...
    game.physics.arcade.collide(this.player, this.boulder);

    if (this.boulder.body.velocity > 0) {
...
GameState.prototype.render = function() {
    ...
    game.debug.text('angularVelocity: ' + this.boulder.body.angularVelocity, 32, 200);
    game.debug.text('angularAcceleration: ' + this.boulder.body.angularAcceleration, 32, 232);
